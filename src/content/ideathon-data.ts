export const ideathonData = {
  global: {
    ...
    tagline: "Powered by SkilliZee | India's Future-Ready Innovation Challenge",
    primaryColor: "#00F0FF", // Electric Blue
    secondaryColor: "#B026FF", // Neon Purple
    accentGreen: "#00FF66",
    accentGold: "#FFD700"
  },
  scene1: {
    title: "IDEATHON 2026",
    subtitle: "Where Ideas Compete. Innovators Rise. Legends Are Made.",
    tagline: "Powered by SkilliZee | India's Future-Ready Innovation Challenge",
    words: ["THINK", "CREATE", "BUILD", "PITCH", "WIN"]
  },
  scene2: {
    title: "DO YOU HAVE WHAT IT TAKES?",
    lines: [
      "Every great invention started with a simple idea.",
      "What if YOUR idea could become the next big solution?",
      "What if YOUR team becomes the champion of Ideathon 2026?",
      "The question is...",
      "Will you watch from the audience...",
      "or stand in the spotlight?"
    ]
  },
  scene3: {
  ...
  scene10: {
    title: "WHO WILL OWN THE SPOTLIGHT?",
    lines: [
      "A year from now...",
      "Some students will remember watching.",
      "Others will remember winning.",
      "Some students will talk about ideas.",
      "Others will build them.",
      "Some students will stay in the audience.",
      "Others will stand on the stage.",
      "The choice is yours."
    ],
    finale: {
      title: "IDEATHON 2026",
